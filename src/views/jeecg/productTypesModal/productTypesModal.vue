      ...
      <a-form :form="form">
        ...
        <a-form-item label="级别" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-radio-group @change="onChangeMenuType" v-decorator="['menuType',{'initialValue':localMenuType}]">
            <a-radio :value="0">L1</a-radio>
            <a-radio :value="1">L2</a-radio>
          </a-radio-group>
        </a-form-item>
        ...
        <a-form-item
          ...
          label="关键字"
          hasFeedback >
          <a-input placeholder="请输入关键字" v-decorator="[ 'name', validatorRules.name]" :readOnly="disableSubmit"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="描述"
          hasFeedback >
          <a-input placeholder="描述" v-decorator="[ 'name', validatorRules.name]" :readOnly="disableSubmit"/>
        </a-form-item>
        <a-form-item
          v-show="show"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="排序">
          <a-input-number placeholder="请输入排序" style="width: 200px" v-decorator="[ 'sortNo',validatorRules.sortNo]" :readOnly="disableSubmit"/>
        </a-form-item>
        <a-form-item
          v-show="show"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="首页展示排序">
          <a-input-number placeholder="请输入排序" style="width: 200px" v-decorator="[ 'sortNo1',validatorRules.sortNo]" :readOnly="disableSubmit"/>
        </a-form-item>
        <a-form-item
    ...
    computed:{
      validatorRules:function() {
        return {
          ...
          sortNo1:{rules: [{initialValue:1.0,validator: this.validateNumber}]}
        }
      }
    },
    created () {
