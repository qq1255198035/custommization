<template>
  <div id="NewOrder">
      ...
      <a-row style="min-height: 100%;height: 100%;">
            ...
            >
              <a-sub-menu v-for="(item, index) in menuList" :key="index.toString()">
                <span slot="title" style="display: flex;align-items: center;">
                  <a-avatar :size="20" :src="item.icon" style="margin-right: 5px;" />
                  <span>{{item.title}}</span>
                </span>
                <a-menu-item
                  v-for="(sub,sindex) in item.subMenu"
                  :key="'sub'+ index + sindex.toString()"
                  @click="handleGetList(sub.categoryId)"
        ...
        <a-col :span="18" style="height: 100%;">
          ...
          <div class="right">
            ...
            <div class="btn-box">
              <a-button :loading="loading" @click="loadMore" :disabled="btnable">加载更多</a-button>
            </div>
          </div>
        </a-col>
      </a-row>
    ...
    <div id="Design" v-show="show">
          ...
          <div class="design-box">
            <ul class="side-bar">
              <li
                v-for="item in list"
                :key="item.className"
                @click="toolsBtnClick(item.key)"
                :class="{active: item.key == liClick}"
              >
              ...
              <div style class="scroll-box">
                <div class="drawer">
                  ...
                  <div class="tool-box1" v-show="visibletype == 0">
                    ...
                    <h2
                      style="color: #33b8b3;text-align: left; border-bottom: 1px solid #999; padding-bottom: 5px; font-size: 18px;"
                    >
                      <a-icon type="left" style="cursor: pointer;" @click="visibletype = -1" />添加文字
                    </h2>
                    <div class="add-text">
                      <p>Add Text</p>
                  ...
                  <div class="tool-box6" v-show="visibletype == 1">
                    ...
                    <dl v-for="img in imgs" :key="img.className">
                      ...
                      <dd
                        v-for="(item,index) in img.imgURL"
                        :key="item + index"
                        @click="addImg(item,'img'+index)"
                      >
                        <img :src="item" alt />
                      </dd>
                    </dl>
                  ...
                  <div class="tool-box8" v-show="visibletype == 2">
                        ...
                        <div class="color-picker">
                          <p>
                            ...
                            <span
                              ...
                              @click="openChangeColorBox(5,'名称颜色')"
                            ></span>
                          </p>
                          <p>
                            黑色
                            <span
                              :style="{backgroundColor: 'black'}"
                              @click="openChangeColorBox(6,'号码颜色')"
                            ></span>
                          </p>
                        </div>
                      </dd>
                    ...
                    <div style="text-align: center;">
                      <a-button
                        type="primary"
                        :disabled="!addNameData && !addNumberData"
                        @click="visibletype = 9"
                      >输入号码和名称</a-button>
                    </div>
                  </div>
                    ...
                    <ul class="tool-list">
                      ...
                      <li @click="openChangeColorBox(1,'字体颜色')">
                        ...
                        <p>
                          <span>
                            {{colorName}}
                            <i class="square" :style="{backgroundColor:color}"></i>
                          </span>
                          <a-icon type="right" />
                        </p>
                      </li>
                      <li @click="openChangeColorBox(2,'字体背景颜色')">
                        ...
                        <p>
                          <span>
                            {{fontBgColorName}}
                            <i class="square" :style="{backgroundColor:bgcolor}"></i>
                          </span>
                          <a-icon type="right" />
                        </p>
                      </li>
                  ...
                  <div class="tool-box10" v-show="visibletype == 4">
                    ...
                    <p>
                      选择颜色：
                      <span :style="{backgroundColor: '#fff'}"></span> 白色
                    </p>
                    <ul class="color-list">
                      <li
                        ...
                        @click="changeProductColor(index)"
                      >
                  ...
                  <div class="tool-box12" v-show="visibletype == 6">
                    <h2>参考图片：</h2>
                    <div class="upload-box">
                      <a-button type="primary" @click="example = true">上传照片</a-button>
                      <p>可以上传您喜欢的设计作为参考，并附加说明</p>
                    </div>
                    <ul class="info-list">
                  ...
                  <div class="tool-box3" v-show="visibletype == 7">
                    <h2
                      style="color: #333;text-align: left; border-bottom: 1px solid #333; padding-bottom: 5px;"
                    >
                    ...
                    <ul class="font-family-list">
                      <li
                        ...
                        :key="item.id"
                        @click="changeFontFamily(item.name)"
                      >
                  ...
                  <div class="tool-box4" v-show="visibletype == 8">
                    ...
                    <p
                      style="display:flex;align-items: center;margin-top: 20px; font-size: 18px;color: #999;"
                    >
                      选择颜色：
                      <span
                        :style="{backgroundColor: color}"
                        style="width: 20px;height: 20px;display: inline-block;margin:0 10px;border:1px solid #ccc;"
                      ></span>
                      {{colorName}}
                    </p>
                    <ul class="color-list-box">
                      <li
                        ...
                        :key="item.name"
                        :style="{backgroundColor: item.color}"
                        @click="changeAllColor(item.color,item.name,index)"
                      >
                    ...
                    <div style="text-align: center;">
                      <a-button
                        type="primary"
                        style="font-size: 18px;height: 45px;padding: 0 30px;border-radius: 12px;"
                      >保存更改</a-button>
                    </div>
                  </div>
                  <div class="tool-box5" v-show="visibletype == 9">
                    ...
                    <div>
                      ...
                      <a-form :form="form1" @submit="handleSubmit">
                        <a-form-item
                          v-for="k in form1.getFieldValue('keys')"
                          :key="k"
                          :required="false"
                          ...
                          >
                            ...
                            <a-form-item style="width: 20%; margin: 0;min-height: 58px;">
                              <a-input
                                ...
                                placeholder="名称"
                                style="width: 100%;border-radius: 0;border-right: none"
                              />
                            </a-form-item>
                  ...
                  <div class="tool-box2" v-show="visibletype == 10">
                    ...
                    <ul class="first">
                      ...
                      <li class="set-layer">
                        <span title="移动到顶层" @click="toTopLayer">
                          <i class="icon-top_layer"></i>
                        </span>

                        <span title="移动倒底层" @click="toBottomLayer">
                          <i class="icon-last_layer"></i>
                        </span>
                        <p>分层</p>
                      </li>
                      <li class="set-filp">
                        <span title="移动到顶层" @click="changeFilPx">
                          <a-icon type="vertical-left" />
                        </span>
                        <span title="移动倒底层" @click="changeFilPy">
                          <a-icon type="vertical-left" style="transform:rotate(90deg)" />
                        </span>
                        <p>翻转</p>
                      </li>
                    </ul>
            ...
            <li style="display:flex">
              ...
              <div>
                <a-button
                  ...
                  @click="saveEndDesign"
                >
                  <span class="icon-save" style="margin-right: 10px;vertical-align: middle"></span>保存设计
                </a-button>
              </div>
              <!--<a-button
                icon="plus"
                v-intro="'The content of tooltip'"
                v-intro-step="2"
                @click="$router.push({path: '/neworder'})"
              >添加产品</a-button>-->
            </li>
          </ul>
        </div>
      </a-modal>
      <a-modal v-model="example" title="参考图片上传：" :centered="true" width="40%" :footer="null">
        <div class="upLoadExampleImg">
          <a-form :form="form" style="display: flex;justify-content: space-between;">
            ...
            >
              <a-textarea
                :rows="4"
                v-decorator="['bz',{rules: [{ required: true, message: '请填写说明！' }]}]"
              />
            </a-form-item>
          </a-form>
          <div class="btn-box">
      ...
      <a-modal v-model="endDsign" title="保存设计" :centered="true" width="40%" :footer="null">
  ...
  data() {
    return {
      ...
      imgs: [
        ...
        {
          className: "剪贴画",
          imgURL: [img1, img1, img1, img1, img1]
        }
      ],
      list: [
        {
    ...
    addExampleNumber(font) {
      ...
      myfont
        ...
        .then(function() {
          ...
          that.myCanvas
            .add(that.exampleNumber)
            .setActiveObject(that.exampleNumber);
