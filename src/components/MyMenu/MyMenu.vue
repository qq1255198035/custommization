      ...
      <div id="MyMenu">
            <a-menu mode="inline" :defaultSelectedKeys="[$route.name]" :defaultOpenKeys="openKeys()">
                  ...
                  <a-sub-menu key="commission" class="my-submenu">
                        ...
                        <a-menu-item key="commissions"><router-link to="/commissions">佣金管理</router-link></a-menu-item>
                        <a-menu-item key="commissionsdetails"><router-link to="/commissionsdetails">佣金明细</router-link></a-menu-item>
                  </a-sub-menu>
      ...
      methods: {
            openKeys(){
                  if(this.$route.name == 'perorder' || this.$route.name == 'grouporder'){
                        return ['order']
                  }else if(this.$route.name == 'commissions' || this.$route.name == 'commissionsdetails'){
                        return ['commission']
                  }
            }
      },
